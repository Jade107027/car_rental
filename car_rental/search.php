...
$results = array_filter($cars, function ($car) use ($searchQuery) {
    return stripos($car['model'], $searchQuery) !== false ||
           stripos($car['brand'], $searchQuery) !== false ||
           stripos($car['type'], $searchQuery) !== false;
});
...
$filteredCars = array_values($results);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Daun - Search Results</title>
